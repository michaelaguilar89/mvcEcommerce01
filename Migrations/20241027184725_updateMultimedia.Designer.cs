...
namespace MVCEcommerce.Migrations
{
    ...
    [Migration("20241027184725_updateMultimedia")]
    partial class updateMultimedia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCEcommerce.Models.Multimedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MVCEcommerce.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreationModificationDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("MVCEcommerce.Models.Multimedia", b =>
                {
                    b.HasOne("MVCEcommerce.Models.Product", "Product")
                        .WithOne("Multimedia")
                        .HasForeignKey("MVCEcommerce.Models.Multimedia", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
